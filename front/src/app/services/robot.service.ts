...
export class RobotService {
  ...
  deleteRobot(accountId: string, robotId: string) {
    return this.apollo.mutate<{ deleteRobot: string }>({
  ...
  upsertRobot(accountId: string, input: RobotInput) {
    return this.apollo.mutate<{ upsertRobot: Robot }>({
